...
/**
 * POST /integrations/genesys/notify — relay for Genesys notifications.
...
/**
 * POST /integrations/genesys/sync — on-demand single-user pull.
 * Delegates to the Convex action, which fetches from Genesys and records health.
